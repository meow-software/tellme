...
import { EB, EVENT_BUS, SnowflakeService, UserDTO, type IEventBus, AuthCodes } from 'src/lib/common';
...
export class DeleteUserHandler implements ICommandHandler<DeleteUserCommand> {
  ...
  async execute(command: DeleteUserCommand) {
    ...
    if (!user) throw new NotFoundException({ code: AuthCodes.NOT_FOUND, message: 'User not found' });
